...
if __name__ == "__main__":
    ...
    train_file = sys.argv[3] if len(sys.argv) > 3 else "obesity_data_train_preprocessing.csv"
    test_file = sys.argv[4] if len(sys.argv) > 4 else "obesity_data_test_preprocessing.csv"
